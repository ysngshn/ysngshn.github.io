...
IVON is proposed in our paper "[Variational Learning is Effective for Large Deep Networks][paper-arxiv]", accepted at ICML 2024. This work results from a long collaboration dating back to 2021, and I had the pleasure to implement and revise this optimizer many times with my own hands, and witness how a great idea can be realized and gradually improved.
...
- Github (IVON package): [github.com/team-approx-bayes/ivon][ivon-github]
